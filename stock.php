	...
	<div class="panel panel-success">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				...
				<button type='button' class="btn btn-success" data-toggle="modal" data-target="#nuevoProducto"><span class="glyphicon glyphicon-plus" ></span> Importar</button>
			</div>
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form" id="datos">
				...
				<div class="row">
					<div class='col-md-4'>
						<label>Filtrar por proveedor o nombre</label>
						<input type="text" class="form-control" id="q" placeholder="Proveedor o nombre del producto" onkeyup='load(1);'>
					</div>
