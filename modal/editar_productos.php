	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div class="form-group">
		    <label for="placa" class="col-sm-3 control-label">Placa Vehiculo</label>
		    <div class="col-sm-8">
			<input type="text" class="form-control" id="placa" name="placa" placeholder="Placa Vehicular" required>
			</div>
			</div>
			<div class="form-group">
			<label for="peso" class="col-sm-3 control-label">peso</label>
			<div class="col-sm-8"> 
		    <input type="text" class="form-control" id="peso" name="peso" placeholder="Peso" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa el peso" maxlength="8">
		    </div>
			</div>
			<div class="form-group">
